...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::List>::serializedSize(Protocol const* proto, nebula::List const* obj) {
    uint32_t xfer = 0;
    ...
    xfer += detail::pm::protocol_methods<
        ...
        std::vector<nebula::Value>>::serializedSize<false>(*proto, obj->values);
...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::List>::serializedSizeZC(Protocol const* proto, nebula::List const* obj) {
    uint32_t xfer = 0;
    xfer += proto->serializedStructSize("List");
