...
_readField_dst : { Cpp2Ops<nebula::Vertex>::read(proto, &obj->dst); }
...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::Step>::serializedSize(Protocol const* proto, nebula::Step const* obj) {
    uint32_t xfer = 0;
...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::Step>::serializedSizeZC(Protocol const* proto, nebula::Step const* obj) {
    uint32_t xfer = 0;
    xfer += proto->serializedStructSize("Step");
...
_readField_src : { Cpp2Ops<nebula::Vertex>::read(proto, &obj->src); }
...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::Path>::serializedSize(Protocol const* proto, nebula::Path const* obj) {
    uint32_t xfer = 0;
...
template <>
template <class Protocol>
uint32_t Cpp2Ops<nebula::Path>::serializedSizeZC(Protocol const* proto, nebula::Path const* obj) {
    uint32_t xfer = 0;
    xfer += proto->serializedStructSize("Path");
