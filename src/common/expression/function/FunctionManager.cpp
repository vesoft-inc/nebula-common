...
FunctionManager::FunctionManager() {
    {
        ...
        attr.body_ = [] (const auto &args) {
            return std::abs(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::floor(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::ceil(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::round(boost::get<double>(args[0]));
        };
    }
    {
        // square root
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::sqrt(boost::get<double>(args[0]));
        };
    }
    {
        // cubic root
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::cbrt(boost::get<double>(args[0]));
        };
    }
    {
        // sqrt(x^2 + y^2)
        ...
        attr.maxArity_ = 2;
        attr.body_ = [] (const auto &args) {
            auto x = boost::get<double>(args[0]);
            auto y = boost::get<double>(args[1]);
    ...
    }
    {
        ...
        attr.maxArity_ = 2;
        attr.body_ = [] (const auto &args) {
            auto base = boost::get<double>(args[0]);
            auto exp = boost::get<double>(args[1]);
    ...
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::exp(boost::get<double>(args[0]));
        };
    }
    {
        // 2^x
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::exp2(boost::get<double>(args[0]));
        };
    }
    {
        // e-based logarithm
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::log(boost::get<double>(args[0]));
        };
    }
    {
        // 2-based logarithm
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::log2(boost::get<double>(args[0]));
        };
    }
    {
        // 10-based logarithm
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::log10(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::sin(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::asin(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::cos(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::acos(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::tan(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            return std::atan(boost::get<double>(args[0]));
        };
    }
    {
        ...
        attr.body_ = [] (const auto &args) -> StatusOr<VariantType> {
            ...
            auto min = boost::get<int64_t>(args[0]);
            auto max = boost::get<int64_t>(args[1]);
            if (max < 0 || min < 0) {
                return Status::InvalidParameter("Invalid negative number");
            }
            if (max > std::numeric_limits<uint32_t>::max() ||
    ...
    }
    {
        ...
        attr.maxArity_ = 2;
        attr.body_ = [] (const auto &args) {
            auto &left = boost::get<std::string>(args[0]);
            auto &right = boost::get<std::string>(args[1]);
    ...
    }
    {
        ...
        attr.maxArity_ = 1;
        attr.body_ = [] (const auto &args) {
            auto value = boost::get<std::string>(args[0]);
    ...
    }
    {
        ...
        attr.body_ = [] (const auto &args) {
            auto value = boost::get<std::string>(args[0]);
            auto length = boost::get<int64_t>(args[1]);
            if (length <= 0) {
                return std::string();
            }
    ...
    }
    {
        ...
        attr.body_ = [] (const auto &args) {
            auto value = boost::get<std::string>(args[0]);
            size_t size  = boost::get<int64_t>(args[1]);
            ...
            if (size < 0) {
                ...
                auto extra = boost::get<std::string>(args[2]);
                size -= value.size();
    ...
    }
    {
        ...
        attr.body_ = [] (const auto &args) {
            auto value   = boost::get<std::string>(args[0]);
            auto start   = boost::get<int64_t>(args[1]);
            auto length  = boost::get<int64_t>(args[2]);
    ...
    }
    {
        ...
        attr.body_ = [] (const auto &args) {
            ...
            switch (cmp.which()) {
                case VAR_INT64: {
                    auto v = boost::get<int64_t>(cmp);
                    std::unordered_set<uint64_t> vals;
                    for (auto iter = (args.begin() + 1); iter < args.end(); ++iter) {
                        vals.emplace(boost::get<int64_t>(*iter));
                    }
                    auto ret = vals.emplace(v);
                    return !ret.second;
                }
                case VAR_DOUBLE: {
                    auto v = boost::get<double>(cmp);
                    std::unordered_set<double> vals;
                    for (auto iter = (args.begin() + 1); iter < args.end(); ++iter) {
                        vals.emplace(boost::get<double>(*iter));
                    }
                    auto ret = vals.emplace(v);
                    return !ret.second;
                }
                case VAR_BOOL: {
                    auto v = boost::get<bool>(cmp);
                    std::unordered_set<bool> vals;
                    for (auto iter = (args.begin() + 1); iter < args.end(); ++iter) {
                        vals.emplace(boost::get<bool>(*iter));
                    }
                    auto ret = vals.emplace(v);
                    return !ret.second;
                }
                case VAR_STR: {
                    auto v = boost::get<std::string>(cmp);
                    std::unordered_set<std::string> vals;
                    for (auto iter = (args.begin() + 1); iter < args.end(); ++iter) {
                        vals.emplace(boost::get<std::string>(*iter));
                    }
                    auto ret = vals.emplace(v);
                    return !ret.second;
                }
    ...
    }
    {
        ...
        attr.body_ = [] (const auto &args) {
            ...
            for (decltype(args.size()) i = 0; i < mid; ++i) {
                auto xi = boost::get<double>(args[i]);
                auto yi = boost::get<double>(args[i + mid]);
                s1 += (xi * yi);
                s2 += (xi * xi);
                s3 += (yi * yi);
            }
