...
#define PLOG(severity)                                                                             \
    _MINLOGLEVEL_GT_##severity ? (void)0                                                           \
...
#define SOME_KIND_OF_LOG_EVERY_N(severity, n, what_to_do)                                          \
    ...
    google::LogMessage(__FILE__, __LINE__, google::GLOG_##severity, LOG_OCCURRENCES, &what_to_do)  \
        .stream()
...
#define SOME_KIND_OF_PLOG_EVERY_N(severity, n, what_to_do)                                         \
    ...
    google::ErrnoLogMessage(                                                                       \
        __FILE__, __LINE__, google::GLOG_##severity, LOG_OCCURRENCES, &what_to_do)                 \
        .stream()
...
#define LOG_EVERY_N(severity, n)                                                                   \
    GOOGLE_GLOG_COMPILE_ASSERT(google::GLOG_##severity < google::NUM_SEVERITIES,                   \
