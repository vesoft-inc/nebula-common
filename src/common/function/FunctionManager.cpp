...
/*static*/ StatusOr<bool> FunctionManager::getStateless(const std::string &func, size_t arity) {
    auto result = instance().getInternal(func, arity);
    NG_RETURN_IF_ERROR(result);
    return result.value().stateless_;
}
