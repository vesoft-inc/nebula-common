...
enum IndexType {
    ...
    NORMAL         = 0x02,   // lookup tag/edge
    VERTEX         = 0x03,   // statistics vertex count or vertices on one tag
    EDGE           = 0x04,   // statistics edge count or edges on one edgetype edge
    VERTEX_COUNT   = 0x05,   // statistics vertex count on one space
    EDGE_COUNT     = 0x06,   // statistics edge count on one space
}
